...
public class WeatherConstants {
    ...
    public static final String AIR_NOW_API_URL = "https://devapi.qweather.com/v7/air/now?";

    public static final String PARAM_KEY_KEY = "key";

    public static final String PARAM_KEY_LOCATION = "location";

    public static final String WEATHER_TEMPLATE = "【${cityName}】当前 ${text}，气温${temp}℃，体感温度${feelsLike}℃，${windDir}${windScale}级，相对湿度${humidity}%\n" +
            "空气质量：${category}，空气质量指数：${aqi}${primary}\n" +
            "【未来三日天气】\n";
